...
// want the pattern should start with '^' and end with '$'
//godogen:when we do not have anchors
// want the pattern should start with '^' and end with '$'
//godogen:^when we do not have end anchors
// want the pattern should start with '^' and end with '$'
//godogen:when we do not have start anchors$
func missingAnchors(ctx context.Context) error {
	return nil
}
